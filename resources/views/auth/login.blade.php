<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="mt-8 space-y-5">
        ...
        <a href="#" class="flex w-full items-center justify-center gap-2 rounded-full border border-ink-200 bg-white px-5 py-3 text-sm font-bold text-ink-700 hover:border-prism-violet">
            ...
            <span class="ml-1 text-[10px] uppercase tracking-widest text-ink-500">soon</span>
        </a>
