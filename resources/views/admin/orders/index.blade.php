                ...
                <tbody class="divide-y divide-ink-100">
                    @forelse($orders as $o)
                        <tr class="hover:bg-ink-50">
                            <td class="px-4 py-3 whitespace-nowrap"><a href="{{ route('admin.orders.show', $o) }}"
                                    class="font-mono text-xs hover:text-prism-violet">{{ $o->code }}</a></td>
                            <td class="px-4 py-3 whitespace-nowrap">{{ $o->user?->name }}</td>
                            ...
                            <td class="px-4 py-3 text-xs whitespace-nowrap">{{ $o->payment_status }}</td>
                            <td class="px-4 py-3 text-right font-mono whitespace-nowrap">@idr($o->total)</td>
