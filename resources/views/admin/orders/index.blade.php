        ...
        <tbody class="divide-y divide-ink-100">
            @forelse($orders as $o)
                <tr class="hover:bg-ink-50">
                    <td class="px-4 py-3"><a href="{{ route('admin.orders.show', $o) }}" class="font-mono text-xs hover:text-prism-violet">{{ $o->code }}</a></td>
            ...
            @empty
                <tr><td colspan="6" class="px-4 py-10 text-center text-sm text-ink-500">No orders yet.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
