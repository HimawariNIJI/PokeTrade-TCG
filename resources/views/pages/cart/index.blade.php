        ...
        <div class="grid gap-8 lg:grid-cols-12">
            ...
            <div class="space-y-3 lg:col-span-8">
                @foreach($items as $line)
                    ...
                    @endphp
                    <article class="flex flex-wrap items-start gap-4 rounded-2xl border border-ink-200 bg-white p-4">
                        ...
                        <div class="min-w-0 flex-1">
                            <a href="{{ $href }}"
                            class="line-clamp-2 font-display text-base font-black text-ink-900 hover:text-prism-violet">
                                {{ $name }}
                            </a>
                        ...
                        @if($line->itemable_type === 'App\\Models\\ShopItem')
                            <div class="flex w-full justify-end md:w-auto md:justify-center md:self-center md:gap-3">
