        ...
        <div class="grid gap-12 lg:grid-cols-2">
            ...
            <div>
                ...
                <div class="mt-8 rounded-3xl border border-ink-200 bg-white p-6">
                    ...
                    @else
                        {{-- Tampilan pengganti jika yang login adalah admin --}}
                        <div class="mt-5 rounded-2xl bg-ink-50 p-4 text-center text-sm font-medium text-ink-500 border border-ink-200">
