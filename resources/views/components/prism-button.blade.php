...
@php
    $base = 'group relative inline-flex items-center justify-center gap-2 font-display font-bold tracking-wide rounded-full transition-all duration-200 hover:scale-105 active:scale-95 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-prism-violet focus-visible:ring-offset-2';
    $sz = match ($size) {
    ...
    $variantCls = match ($variant) {
        ...
        'ghost'   => 'text-ink-900 bg-white/70 backdrop-blur hover:bg-white hover:border-prism-violet hover:text-prism-violet hover:shadow-lg border border-ink-200',
